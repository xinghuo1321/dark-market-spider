 ...
 * object, containing series and an xAxis with categorys if applicable. Thise options
 ...
 * array directly, before they are interpreted into series data and categorys.
 *
 * - parseDate : Function
...
(function (Highcharts) {	
	...
	complete: function () {
		...
		if (options.complete) {
			...
			// Use first column for X data or categorys?
			if (columns.length > 1) {
