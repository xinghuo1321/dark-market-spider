jQuery(function () {
    $("div.panel.panel-default.widget.html .panel-heading .icon.chevron").toggleClass("fa fa-chevron-up").toggleClass("fa fa-chevron-down");
    $("div.panel.panel-default.widget.html .panel-body").toggle('fast');
    $(".column").sortable({
        connectWith: ".column",
